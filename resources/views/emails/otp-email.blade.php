                                                                                            ...
                                                                                            <table width="100%"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="text-16 lh-26 a-center pb-25"
                                                                                                        ...
                                                                                                        app:
                                                                                                        <br>
                                                                                                        {{-- <span style="color:black !important;font-weight:bold;">2015</span> --}}
                                                                                                        <span style="color:black !important;font-weight:bold;">{{$data['code']}}</span>
                                                                                                        <br>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <td align="center" class="pb-20"
                                                                    ...
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td class="img" width="34"
                                                                                style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="https://www.instagram.com/p/CG2iO4kHola/?igshid=YmMyMTA2M2Y=" target="_blank"><img
                                                            ...
                                                            <tr>
                                                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                                                    ...
                                                                    5706 birchview place Clinton md 20735, US
                                                                    <br />
                                                                    <a href="tel:+17384796719" target="_blank"
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">+240 521 0521</span></a> 
                                                                            
                                                                        {{-- <a href="tel:+13697181973" target="_blank"
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            ...
                                                                            718-1973</span></a> --}}
                                                                    <br />
                                                                    <a href="mailto:info@afla.app" target="_blank"
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">info@afla.com</span></a>
                                                                    - <a href="www.afla.app" target="_blank"
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">www.afla.com</span></a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center">
