        ...
        <div class="container">
            ...
            <div class="row mb-3 col-md-6 offset-md-6">
                ...
                <div style="display: inherit;">
                    ...
                    <p style="padding-left: 10px;padding-top: 10px;"><span>US Dollar (USD)</span> = <span
                            id="RATESPAN">{{end($data_periods)}}</span> <span>{{ $currency }}</span></p>
            ...
            <div class="row mb-3 col-md-6 offset-md-6">
                <div class="col-xl-12 col-lg-12">
                    <form action="{{route('detail_page_usd',[$symbol])}}" class="convert-form">
                    ...
                    <div style="margin: 20px; margin-left:0px">
                        <h6>Quick Range</h6>
                        <p> 
                            <a class="range" href="{{route('detail_page_usd',[$symbol,'7Days'])}}">7 Days</a>  
                            <a class="range" href="{{route('detail_page_usd',[$symbol,'2Weeks'])}}">2 Weeks</a> 
                            <a class="range" href="{{route('detail_page_usd',[$symbol,'1Mon'])}}">1 Mon</a>   
                            <a class="range" href="{{route('detail_page_usd',[$symbol,'3Mon'])}}">3 Mon</a>   
                            <a class="range" href="{{route('detail_page_usd',[$symbol,'6Mon'])}}">6 Mon</a>   
                            <a class="range" href="{{route('detail_page_usd',[$symbol,'1Yr'])}}">1 Yr</a>    
                            <a class="range" href="{{route('detail_page_usd',[$symbol,'2Yrs'])}}">2 Yrs</a>   
                            <a class="range" href="{{route('detail_page_usd',[$symbol,'3Yrs'])}}">3 Yrs</a>
                        </p>
                    </div> 
                </div>
            </div>
