...
<div class="content-wrapper">
        ...
        <div class="container">
            ...
            <div class="partner-slider owl-carousel">
                <div class="partner-item">
                    <img src="{{url('')}}/website_{{url('')}}/website_assets/img/partner/partner-1.png" alt="Image">
                </div>
                <div class="partner-item">
                    <img src="{{url('')}}/website_assets/img/partner/partner-2.png" alt="Image">
                </div>
                <div class="partner-item">
                    <img src="{{url('')}}/website_assets/img/partner/partner-3.png" alt="Image">
                </div>
                <div class="partner-item">
                    <img src="{{url('')}}/website_assets/img/partner/partner-4.png" alt="Image">
                </div>
                <div class="partner-item">
                    <img src="{{url('')}}/website_assets/img/partner/partner-5.png" alt="Image">
                </div>
                <div class="partner-item">
                    <img src="{{url('')}}/website_assets/img/partner/partner-6.png" alt="Image">
                </div>
                <div class="partner-item">
                    <img src="{{url('')}}/website_assets/img/partner/partner-7.png" alt="Image">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-6 about-img-wrap">
                            <img src="{{url('')}}/website_assets/img/about/about-shape-4.png" alt="Image"
                                class="about-shape-one bounce">
                            <div class="about-img">
                                <img src="{{url('')}}/website_assets/img/about/about-img-1.jpg" alt="Image">
                            </div>
                            <div class="about-img">
                                <img src="{{url('')}}/website_assets/img/about/about-img-2.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="col-6 about-img-wrap lgm-70">
                            <img src="{{url('')}}/website_assets/img/shape-1.png" alt="Image"
                                class="about-shape-two moveHorizontal">
                            <div class="about-img">
                                <img src="{{url('')}}/website_assets/img/about/about-img-3.jpg" alt="Image">
                            </div>
                            <div class="about-img">
                                <img src="{{url('')}}/website_assets/img/about/about-img-4.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="about-content">
                        <div class="content-title style1">
                            ...
                            <p>Best Strategic planning dolor sit amet consectetur adipiscing elit. Scel erus
                                isque ametus odio velit auctor nam elit nulla eget sodales dui pulvinar dolor
                                strategic planning dolor sit sectetur morethe.</p>
                        </div>
                        ...
                        <a href="about.html" class="btn style1">READ MORE<i
            ...
            <div class="row justify-content-center">
                <div class=" col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                    <div class="feature-card style1">
                        ...
                        <p>Lorem ipsum dolor sit amet ametus conso tetur ading elitor fugit piatur iusto provid.
                        </p>
                ...
                <div class=" col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                    <div class="feature-card style1">
                        ...
                        <a href="chart.html" class="link style1">View Charts<i
                                class="ri-arrow-right-s-line"></i></a>
                    </div>
                </div>
                <div class=" col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                    <div class="feature-card style1">
                        ...
                        <a href="alerts.html" class="link style1">Create Alerts<i
                                class="ri-arrow-right-s-line"></i></a>
                    </div>
                </div>
                <div class=" col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            ...
            <div class="row gx-5 align-items-center">
                ...
                <div class="col-lg-6 order-lg-2 order-md-1 order-1">
                    <div class="wh-img-wrap">
                        <img src="{{url('')}}/website_assets/img/shape-6.png" alt="Image" class="wh-shape-one animationFramesTwo">
                        <img src="{{url('')}}/website_assets/img/why-choose-us/wh-img-7.jpg" alt="Image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    <div class="section-title style1 text-center mb-40">
                        ...
                        <h2>The Most Trusted Currency Exchange Is Here For Giving Services</h2>
                    </div>
                </div>
            </div>
    ...
    <section class="app-wrap style2 ptb-100">
        <div class="container">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    <div class="app-img-wrap">
                        <img src="{{url('')}}/website_assets/img/shape-5.png" alt="Image" class="app-shape-one bounce">
                        <img src="{{url('')}}/website_assets/img/app-screen.png" alt="Image">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="app-content">
                        <div class="content-title style1">
                            ...
                            <p>In our dolore with people who are important to you, conversations that bring you
                                to closer to each other and those who enjoy our dishes. Quisque pretium dolor
                                turpis, quis blandit turpis semper ut. Nam malesuada eros nec luctus laoreet.
                                Fusce sodales consequat velit eget dictum. Integer ornare magna.</p>
                        </div>
                        <h5>Over 70 million Downloads Worldwide</h5>
                        <div class="app-btn-wrap">
                            <a href="{{url('/')}}">
                                <img src="{{url('')}}/website_assets/img/about/play-store.png" alt="Image">
                            </a><a href="{{url('/')}}">
                                <img src="{{url('')}}/website_assets/img/about/app-store.png" alt="Image">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="testimonial-slider-two owl-carousel">
                <div class="testimonial-card style3">
                    <div class="client-info-area">
                        <div class="client-info-wrap">
                            <div class="client-img">
                                <img src="{{url('')}}/website_assets/img/testimonials/client-3.jpg" alt="Image">
                            </div>
                    ...
                    <p class="client-quote">Best Strategic planning dolor sit amet consectetur adicing elit.
                        Scel erus isque ametus odio velit auctor nam elit nulla eget sodales dui pulvinar. Best
                ...
                <div class="testimonial-card style3">
                    <div class="client-info-area">
                        <div class="client-info-wrap">
                            <div class="client-img">
                                <img src="{{url('')}}/website_assets/img/testimonials/client-4.jpg" alt="Image">
                            </div>
                            <div class="client-info">
                                <h3>Alex Cruis</h3>
                                <span>CEO, IBAC</span>
                ...
                <div class="testimonial-card style3">
                    <div class="client-info-area">
                        <div class="client-info-wrap">
                            <div class="client-img">
                                <img src="{{url('')}}/website_assets/img/testimonials/client-5.jpg" alt="Image">
                            </div>
                            <div class="client-info">
                                <h3>Tom Haris</h3>
                ...
                <div class="testimonial-card style3">
                    <div class="client-info-area">
                        <div class="client-info-wrap">
                            <div class="client-img">
                                <img src="{{url('')}}/website_assets/img/testimonials/client-1.jpg" alt="Image">
                            </div>
                            <div class="client-info">
                                <h3>Harry Jackson</h3>
                ...
                <div class="testimonial-card style3">
                    <div class="client-info-area">
                        <div class="client-info-wrap">
                            <div class="client-img">
                                <img src="{{url('')}}/website_assets/img/testimonials/client-2.jpg" alt="Image">
                            </div>
                            <div class="client-info">
                                <h3>Chris Haris</h3>
                                <span>MD, ITec</span>
